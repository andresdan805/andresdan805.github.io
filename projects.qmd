...
:::: {layout="[70,30]"}
::: {}
Simulated 1,000 market scenarios to evaluate portfolio allocations for a municipal 
retirement fund over a 30-year horizon, assessing insolvency risk, volatility, 
and ending surplus across equity/fixed-income splits

[PDF](files/PSTAT_177_final.pdf)   
:::

::: {}
![](media/Rolling Returns.png){width=70%}
